  ...
  data: [
    {
      ...
      skills: [
        "⚡ Interfaces responsives et accessibles avec HTML5, CSS3, Tailwind et React",
    ...
    },
    {
      ...
      skills: [
        "⚡ Création d’APIs REST simples avec PHP/Laravel (auth, CRUD)",
        "⚡ Modélisation et requêtes SQL avec MySQL",
        "⚡ Déploiement simple (O2Switch/Shared Hosting, Vercel pour le front)"
      ],
      softwareSkills: [
    ...
    },
    {
      ...
      skills: [
        ...
        "⚡ Maquettage rapide & handoff avec Figma",
